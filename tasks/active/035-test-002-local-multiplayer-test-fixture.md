# Task 035: Use local websocket fixture for deterministic multiplayer tests
...
## Problem Statement
Use local websocket fixture for deterministic multiplayer tests is tracked in `tasks/active/017-project-wide-code-review-and-hardening-plan.md` and needs a standalone implementation task for execution and ownership.

---

## Scope
- Address only **TEST-002** in this task.
...
## Success Criteria
1. The root cause for **TEST-002** is fixed in code.
...
|---|---|
| 1 | Reproduce before/after behavior for TEST-002 |
...
## Initial Plan
1. Confirm reproduction path and exact acceptance boundaries for TEST-002.
