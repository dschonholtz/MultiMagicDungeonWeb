# Task 033: Move client websocket URL to env/host-driven config
...
## Problem Statement
Move client websocket URL to env/host-driven config is tracked in `tasks/active/017-project-wide-code-review-and-hardening-plan.md` and needs a standalone implementation task for execution and ownership.

---

## Scope
- Address only **SEC-003** in this task.
...
## Success Criteria
1. The root cause for **SEC-003** is fixed in code.
...
|---|---|
| 1 | Reproduce before/after behavior for SEC-003 |
...
## Initial Plan
1. Confirm reproduction path and exact acceptance boundaries for SEC-003.
