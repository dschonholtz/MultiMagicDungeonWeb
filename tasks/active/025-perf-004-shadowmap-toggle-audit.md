# Task 025: Audit and disable unnecessary shadow map work
...
## Problem Statement
Audit and disable unnecessary shadow map work is tracked in `tasks/active/017-project-wide-code-review-and-hardening-plan.md` and needs a standalone implementation task for execution and ownership.

---

## Scope
- Address only **PERF-004** in this task.
...
## Success Criteria
1. The root cause for **PERF-004** is fixed in code.
...
|---|---|
| 1 | Reproduce before/after behavior for PERF-004 |
...
## Initial Plan
1. Confirm reproduction path and exact acceptance boundaries for PERF-004.
