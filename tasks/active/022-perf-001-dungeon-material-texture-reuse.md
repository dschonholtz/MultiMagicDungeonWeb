# Task 022: Reduce texture/material cloning in dungeon renderer
...
## Problem Statement
Reduce texture/material cloning in dungeon renderer is tracked in `tasks/active/017-project-wide-code-review-and-hardening-plan.md` and needs a standalone implementation task for execution and ownership.

---

## Scope
- Address only **PERF-001** in this task.
...
## Success Criteria
1. The root cause for **PERF-001** is fixed in code.
...
|---|---|
| 1 | Reproduce before/after behavior for PERF-001 |
...
## Initial Plan
1. Confirm reproduction path and exact acceptance boundaries for PERF-001.
