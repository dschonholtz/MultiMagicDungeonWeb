# Task 029: Harden server move validation for full payload
...
## Problem Statement
Harden server move validation for full payload is tracked in `tasks/active/017-project-wide-code-review-and-hardening-plan.md` and needs a standalone implementation task for execution and ownership.

---

## Scope
- Address only **NET-004** in this task.
...
## Success Criteria
1. The root cause for **NET-004** is fixed in code.
...
|---|---|
| 1 | Reproduce before/after behavior for NET-004 |
...
## Initial Plan
1. Confirm reproduction path and exact acceptance boundaries for NET-004.
