# Task 036: Add reconnect and server-validation regression tests
...
## Problem Statement
Add reconnect and server-validation regression tests is tracked in `tasks/active/017-project-wide-code-review-and-hardening-plan.md` and needs a standalone implementation task for execution and ownership.

---

## Scope
- Address only **TEST-003** in this task.
...
## Success Criteria
1. The root cause for **TEST-003** is fixed in code.
...
|---|---|
| 1 | Reproduce before/after behavior for TEST-003 |
...
## Initial Plan
1. Confirm reproduction path and exact acceptance boundaries for TEST-003.
