# Task 023: Cap or pool dynamic spell and impact lights
...
## Problem Statement
Cap or pool dynamic spell and impact lights is tracked in `tasks/active/017-project-wide-code-review-and-hardening-plan.md` and needs a standalone implementation task for execution and ownership.

---

## Scope
- Address only **PERF-002** in this task.
...
## Success Criteria
1. The root cause for **PERF-002** is fixed in code.
...
|---|---|
| 1 | Reproduce before/after behavior for PERF-002 |
...
## Initial Plan
1. Confirm reproduction path and exact acceptance boundaries for PERF-002.
