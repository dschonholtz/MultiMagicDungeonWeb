# Task 032: Tighten static server CORS behavior
...
## Problem Statement
Tighten static server CORS behavior is tracked in `tasks/active/017-project-wide-code-review-and-hardening-plan.md` and needs a standalone implementation task for execution and ownership.

---

## Scope
- Address only **SEC-002** in this task.
...
## Success Criteria
1. The root cause for **SEC-002** is fixed in code.
...
|---|---|
| 1 | Reproduce before/after behavior for SEC-002 |
...
## Initial Plan
1. Confirm reproduction path and exact acceptance boundaries for SEC-002.
