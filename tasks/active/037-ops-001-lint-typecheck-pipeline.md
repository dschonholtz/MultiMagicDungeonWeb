# Task 037: Add lint and optional type-check pipeline
...
## Problem Statement
Add lint and optional type-check pipeline is tracked in `tasks/active/017-project-wide-code-review-and-hardening-plan.md` and needs a standalone implementation task for execution and ownership.

---

## Scope
- Address only **OPS-001** in this task.
...
## Success Criteria
1. The root cause for **OPS-001** is fixed in code.
...
|---|---|
| 1 | Reproduce before/after behavior for OPS-001 |
...
## Initial Plan
1. Confirm reproduction path and exact acceptance boundaries for OPS-001.
